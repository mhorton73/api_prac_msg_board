...
# start server with python -m uvicorn main:app --reload (--port 800x if need be)
...
# Cache-ability
# tie users to messages as owners
...
test_users = {
    ...
    "user2": {"username": "user2", "password": "456"}
}
...
#     token = create_auth_token({"sub": username})
